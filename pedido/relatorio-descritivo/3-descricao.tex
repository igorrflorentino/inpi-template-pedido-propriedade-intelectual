...
determinada\incluido{, inferior ao tempo de resposta do assento de vedação de
dupla face (9)}.

% Exemplo de supressão de parágrafo inteiro: no documento do pedido não imprime
% nada e não consome número, mantendo contínua a numeração do art. 26, II; na
% cópia de comparação sai tachado, com [--] no lugar do número.
\paragraforemovido{A unidade de controle (8) pode ainda ser substituída por um
temporizador mecânico, dispensando o sensor de pressão (7).}
