...
**Convenção de citação:** quando este arquivo, o `README.md` ou um comentário de código citam um artigo sem indicar a norma, trata-se da Portaria/INPI/DIRPA nº 14/2024. "LPI" é a Lei nº 9.279/1996. As normas estão em `referencias-inpi/normas/`; as IN 30/2013 e 31/2013 que estão lá foram **revogadas** pelo art. 66 da Portaria 14/2024 e não devem guiar decisão alguma.
